...
export const Features = forwardRef<HTMLDivElement, FeaturesProps>(
  (_props, ref) => {
    ...
    return (
      <Box
        ref={ref}
        className="flex justify-center bg-[#F8F9FA] py-8 sm:py-16 w-full"
      >
            ...
            <div className="flex justify-center w-full max-w-7xl">
              <div className="flex flex-col items-center gap-8 max-w-3xl text-center">
                ...
                <p className="font-normal text-[#475467] text-lg sm:text-xl">
                  ממציאת ההלוואה הנכונה ועד להשגת הריביות הטובות ביותר, אנו
                  מספקים ייעוץ מומחה וליווי ללא מאמץ כדי להפוך את תהליך המימון
                  לביתך לחלק וללא לחץ.
                </p>
              </div>
            </div>
